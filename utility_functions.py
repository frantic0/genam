...
def export_parameterisable_elmer_sif2(dirname, frequency):
  """
  Input
...
def export_parameterisable_elmer_sif1(dirname, frequency):
  """
  Input
...
End
  ...
  print(sif)
  file = open(f"case-{frequency}.sif","w", encoding="utf-8")
  file.write(sif)
  file.close() 
