...
def parameterize_brick(outerRadius, barLength, barSpacing):
  ...
  sk.addSegmentAbsolute(0.0000000, S0 + Bh + S1)
  ...
  sk.addSegmentAbsolute(3.8480000, l0 - S0 - Bh - S1)
...
Sketch_1 = parameterize_brick(outerRad, subLength, barSpacing )
# Sketch_1 = parameterize_brick(outerRad, barLen['b1'], barSpa['b2'])
# Sketch_1 = parameterize_brick_len(outerRad, subLength)
