...
from matrices.quantized_3_3 import quantized_matrix_3_3
...
lens_name = 'quantized_matrix_3_3' 
...
lens_config = lens_configurator( quantized_matrix_3_3 )
lens = Lens( lens_config, mesh_configurator(1), name = lens_name  )
...
print("Elmer simulation completed: {:.2f} sec".format( time.time() - start) )
...
print("Total pipeline completed: {:.2f} sec".format( time.time() - total_start) )
