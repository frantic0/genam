...
sys.path.insert(0, r'C:/Users/Francisco/Documents/dev/genam')
sys.path.insert(0, r'C:/Users/Francisco/Documents/dev/genam/genam')
sys.path.insert(0, r'C:/Users/Francisco/Documents/dev/genam/tests')
...
from genam.lens_resample_target import Lens as Lens_hemi
...
def export_kernel_1_1_( kernel_id, process_id, PRESSURE_DATA_PATH ) -> None:
   ...
   #  lens_name = f'_1_1_{ kernel_id }_P_{ process_id }' 
    lens_name = f'resample_target' 
   ...
   #  start = time.time()
   #  lens.process_mesh(algo = None) # Create lens mesh 
...
export_kernel_1_1_(0, PID, file_complex_pressure_map)
